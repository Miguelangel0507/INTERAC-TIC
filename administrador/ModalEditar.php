      ...
      <form method="POST" action="recib_Update.php">
        ...
        <div class="modal-body  body-editar" id="cont_modal">
          <div class="form-group">
            <label for="recipient-name" class="col-form-label" style="font-family: cursive;">Estado: <br> <span style="color: gray;"> 1.Activo </span><br><span style="color: gray;"> 2.Inactivo</span></label>
